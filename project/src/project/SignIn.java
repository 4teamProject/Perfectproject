...
public class SignIn extends JPanel implements ActionListener{
	...
	SignIn(){
		...
		la1.setBounds(210,160,100,30);
		la2.setBounds(210,195,100,30);
		la3.setBounds(210,230,100,30);
		la4.setBounds(210,265,100,30);
		la5.setBounds(210,300,100,30);
		
		tf1.setBounds(315, 160, 150, 30);
		tf2.setBounds(315, 195, 150, 30);
		
		pf1.setBounds(315, 230, 150, 30);
		pf2.setBounds(315, 265, 150, 30);
		
		cb.setBounds(315, 300, 150, 30);
		
		p1.setBounds(270, 335, 255, 30);
		p2.setBounds(470, 195, 80, 100);
